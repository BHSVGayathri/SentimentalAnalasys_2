...
<br><br><br><br><br><br><br><br><br>
 <pq> Dear user this mail is already used..</pq><br/><br/>
 <pp> Please use another mail id and register again </pp><br/><br/><br/>
 <a href="UserRegister.jsp"> <h2>Register again</h2></a>
